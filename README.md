...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gst-plugins-bad-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gst-plugins-bad-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gst-plugins-bad
# for installing globally
pixi global install gst-plugins-bad
```
...
It is possible to list all of the versions of `gst-plugins-bad` available on your platform:
...
```
pixi search gst-plugins-bad --channel conda-forge
```
